...
private:
	...
	static bool mMouseWheel;
	static int mMouseWheelValue;
...
public:
	...
	static inline const bool MouseWheel() { return mMouseWheel; }
	static inline const int MouseWheelValue() { return mMouseWheelValue; }
